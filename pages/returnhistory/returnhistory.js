Page({
  ...
  getselllist() {
    ...
    wx.request({
      ...
      data: { pageNum: that.data.pageNum, pageSize: that.data.pageSize, paystatus: that.data.paystatus, bustypes: 1 },
      method: 'GET',
      header: {
  ...
  selllistdetail(e) {
    ...
    if (Object.is(that.data.list[id].paystatus, 0)) {
      ...
      wx.navigateTo({
        url: '../selllistdetail/selllistdetail?parameter=' + JSON.stringify(that.data.list[id])
      })
    }
  },
  ...
  thdetail(e){
    ...
    wx.navigateTo({
      url: '../selllistdetail/selllistdetail?parameter=' + JSON.stringify(that.data.list[index]) + '&sign=2'
    })
  }
})